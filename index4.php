...
$estructura_proyecto = [
    'fase_actual' => [
        ...
        'subtitulo' => '35-40 Videos • Contenido Fundamental • 4 Minutos c/u',
        ...
        'progreso' => 8, // videos actualmente publicados
        'total' => 35,
...
$videos_temario = [
    ...
    // ESTRUCTURA PARA LAS PRÓXIMAS MATERIAS
    'matematicas' => [],
    'fisica' => [],
    'quimica' => [],
    'historia' => [],
...
$total_videos_publicados = $estructura_proyecto['fase_actual']['progreso'];
...
<body>
    ...
    <section id="temario" class="bioreto-section">
        <div class="container">
            ...
            <p class="section-subtitle">35 Videos • Contenido Atemporal • 205 Subíndices • 4 Minutos c/u</p>
